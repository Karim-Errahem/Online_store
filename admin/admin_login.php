...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>nom d'utilisateur par défaut = <span>administrateur</span> & mot de passe = <span>111</span></p>
      ...
      <input type="submit" value="Connecte-toi maintenant" class="btn" name="submit">
   </form>
