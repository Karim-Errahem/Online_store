...
<head>
   ...
   <title>comptes administrateur</title>
...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="register_admin.php" class="option-btn">s'inscrire administrateur</a>
   </div>
   ...
   <div class="box">
      ...
      <p> nom d'administrateur : <span><?= $fetch_accounts['name']; ?></span> </p>
      <div class="flex-btn">
