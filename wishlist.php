...
<section class="products">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="flex">
         <div class="price"><?= $fetch_wishlist['price']; ?>DT</div>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('delete all from wishlist?');">supprimer tous les éléments</a>
   </div>
